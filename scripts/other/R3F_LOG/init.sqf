...
#include "R3F_LOG_ENABLE.h"
	...
	call compile preprocessFile format ["scripts\other\R3F_LOG\%1_strings_lang.sqf", R3F_LOG_CFG_language];
	...
	if (isServer) then
	{
		...
		execVM "scripts\other\R3F_LOG\surveiller_objets_a_proteger.sqf";
	};
	...
	call compile preprocessFile "scripts\other\R3F_LOG\fonctions_generales\lib_geometrie_3D.sqf";
	...
	R3F_LOG_FNCT_determiner_fonctionnalites_logistique = compile preprocessFile "scripts\other\R3F_LOG\fonctions_generales\determiner_fonctionnalites_logistique.sqf";
	
	R3F_LOG_FNCT_calculer_chargement_vehicule = compile preprocessFile "scripts\other\R3F_LOG\transporteur\calculer_chargement_vehicule.sqf";
	R3F_LOG_FNCT_transporteur_charger_auto = compile preprocessFile "scripts\other\R3F_LOG\transporteur\charger_auto.sqf";
	...
	if !(isDedicated) then
	{
		...
		call compile preprocessFile "scripts\other\R3F_LOG\fonctions_generales\lib_visualisation_objet.sqf";
		
		R3F_LOG_FNCT_objet_relacher = compile preprocessFile "scripts\other\R3F_LOG\objet_deplacable\relacher.sqf";
		R3F_LOG_FNCT_objet_deplacer = compile preprocessFile "scripts\other\R3F_LOG\objet_deplacable\deplacer.sqf";
		
		R3F_LOG_FNCT_heliporteur_heliporter = compile preprocessFile "scripts\other\R3F_LOG\heliporteur\heliporter.sqf";
		R3F_LOG_FNCT_heliporteur_larguer = compile preprocessFile "scripts\other\R3F_LOG\heliporteur\larguer.sqf";
		R3F_LOG_FNCT_heliporteur_init = compile preprocessFile "scripts\other\R3F_LOG\heliporteur\heliporteur_init.sqf";
		
		R3F_LOG_FNCT_remorqueur_detacher = compile preprocessFile "scripts\other\R3F_LOG\remorqueur\detacher.sqf";
		R3F_LOG_FNCT_remorqueur_remorquer_deplace = compile preprocessFile "scripts\other\R3F_LOG\remorqueur\remorquer_deplace.sqf";
		R3F_LOG_FNCT_remorqueur_remorquer_direct = compile preprocessFile "scripts\other\R3F_LOG\remorqueur\remorquer_direct.sqf";
		R3F_LOG_FNCT_remorqueur_init = compile preprocessFile "scripts\other\R3F_LOG\remorqueur\remorqueur_init.sqf";
		
		R3F_LOG_FNCT_transporteur_charger_deplace = compile preprocessFile "scripts\other\R3F_LOG\transporteur\charger_deplace.sqf";
		R3F_LOG_FNCT_transporteur_charger_selection = compile preprocessFile "scripts\other\R3F_LOG\transporteur\charger_selection.sqf";
		R3F_LOG_FNCT_transporteur_decharger = compile preprocessFile "scripts\other\R3F_LOG\transporteur\decharger.sqf";
		R3F_LOG_FNCT_transporteur_selectionner_objet = compile preprocessFile "scripts\other\R3F_LOG\transporteur\selectionner_objet.sqf";
		R3F_LOG_FNCT_transporteur_voir_contenu_vehicule = compile preprocessFile "scripts\other\R3F_LOG\transporteur\voir_contenu_vehicule.sqf";
		R3F_LOG_FNCT_transporteur_init = compile preprocessFile "scripts\other\R3F_LOG\transporteur\transporteur_init.sqf";
		
		R3F_LOG_FNCT_usine_remplir_liste_objets = compile preprocessFile "scripts\other\R3F_LOG\usine_creation\remplir_liste_objets.sqf";
		R3F_LOG_FNCT_usine_creer_objet = compile preprocessFile "scripts\other\R3F_LOG\usine_creation\creer_objet.sqf";
		R3F_LOG_FNCT_usine_ouvrir_usine = compile preprocessFile "scripts\other\R3F_LOG\usine_creation\ouvrir_usine.sqf";
		R3F_LOG_FNCT_usine_init = compile preprocessFile "scripts\other\R3F_LOG\usine_creation\usine_init.sqf";
		R3F_LOG_FNCT_usine_revendre_deplace = compile preprocessFile "scripts\other\R3F_LOG\usine_creation\revendre_deplace.sqf";
		R3F_LOG_FNCT_usine_revendre_selection = compile preprocessFile "scripts\other\R3F_LOG\usine_creation\revendre_selection.sqf";
		R3F_LOG_FNCT_usine_revendre_direct = compile preprocessFile "scripts\other\R3F_LOG\usine_creation\revendre_direct.sqf";
		R3F_LOG_FNCT_recuperer_liste_cfgVehicles_par_categories = compile preprocessFile "scripts\other\R3F_LOG\usine_creation\recuperer_liste_cfgVehicles_par_categories.sqf";
		R3F_LOG_FNCT_determiner_cout_creation = compile preprocessFile "scripts\other\R3F_LOG\usine_creation\determiner_cout_creation.sqf";
		
		R3F_LOG_FNCT_objet_init = compile preprocessFile "scripts\other\R3F_LOG\objet_commun\objet_init.sqf";
		R3F_LOG_FNCT_objet_est_verrouille = compile preprocessFile "scripts\other\R3F_LOG\objet_commun\objet_est_verrouille.sqf";
		R3F_LOG_FNCT_deverrouiller_objet = compile preprocessFile "scripts\other\R3F_LOG\objet_commun\deverrouiller_objet.sqf";
		R3F_LOG_FNCT_definir_proprietaire_verrou = compile preprocessFile "scripts\other\R3F_LOG\objet_commun\definir_proprietaire_verrou.sqf";
		
		R3F_LOG_FNCT_formater_fonctionnalites_logistique = compile preprocessFile "scripts\other\R3F_LOG\fonctions_generales\formater_fonctionnalites_logistique.sqf";
		R3F_LOG_FNCT_formater_nombre_entier_milliers = compile preprocessFile "scripts\other\R3F_LOG\fonctions_generales\formater_nombre_entier_milliers.sqf";
		...
		execVM "scripts\other\R3F_LOG\surveiller_conditions_actions_menu.sqf";
		
		/* Auto-détection permanente des objets sur le jeu */
		execVM "scripts\other\R3F_LOG\surveiller_nouveaux_objets.sqf";
		 ...
		 */
		execVM "scripts\other\R3F_LOG\systeme_protection_blessures.sqf";
	};
