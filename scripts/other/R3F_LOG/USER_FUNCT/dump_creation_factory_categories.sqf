 ...
 * @usage nul = [] execVM "scripts\other\R3F_LOG\USER_FUNCT\dump_creation_factory_categories.sqf";
 * 
 * @usage to not dump the comments after the class names, set the optional param 0 to false
 * @usage nul = [false] execVM "scripts\other\R3F_LOG\USER_FUNCT\dump_creation_factory_categories.sqf";
 * 
 * @usage to dump all categories, including empty ones, set param 1 to true
 * @usage nul = [true, true] execVM "scripts\other\R3F_LOG\USER_FUNCT\dump_creation_factory_categories.sqf";
 */
