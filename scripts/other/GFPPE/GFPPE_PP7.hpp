class GFPPE_7
{
	...
	movingenable = true;
	//colorin
	onLoad = "openPP = 7;GFPPE_debug1 = 7;null = [_this] execvm 'scripts\other\GFPPE\GFPPE_open.sqf'";
...
class GFPPE_openPP1: RscButton
{
	idc = 1601;
	text = "RadialBlur"; 
	onButtonClick = "closeDialog 77007;openPP = 1;null = [_this] execvm 'scripts\other\GFPPE\GFPPE.sqf'";
...
class GFPPE_openPP2: RscButton
{
	...
	onButtonClick = "closeDialog 77007;openPP = 2;null = [_this] execvm 'scripts\other\GFPPE\GFPPE.sqf'";
	x = 2 * GUI_GRID_W + GUI_GRID_X;
...
class GFPPE_openPP3: RscButton
{
	idc = 1603;
	text = "WetDistortion"; 
	onButtonClick = "closeDialog 77007;openPP = 3;null = [_this] execvm 'scripts\other\GFPPE\GFPPE.sqf'";
	x = 2 * GUI_GRID_W + GUI_GRID_X;
...
class GFPPE_openPP4: RscButton
{
	...
	onButtonClick = "closeDialog 77007;openPP = 4;null = [_this] execvm 'scripts\other\GFPPE\GFPPE.sqf'";
	x = 2 * GUI_GRID_W + GUI_GRID_X;
...
class GFPPE_openPP5: RscButton
{
	idc = 1605;
	text = "DynamicBlur"; 
	onButtonClick = "closeDialog 77007;openPP = 5;null = [_this] execvm 'scripts\other\GFPPE\GFPPE.sqf'";
	x = 2 * GUI_GRID_W + GUI_GRID_X;
...
class GFPPE_openPP6: RscButton
{
	idc = 1606;
	text = "FilmGrain"; 
	onButtonClick = "closeDialog 77007;openPP = 6;null = [_this] execvm 'scripts\other\GFPPE\GFPPE.sqf'";
	x = 2 * GUI_GRID_W + GUI_GRID_X;
...
class GFPPE_openPP8: RscButton
{
	idc = 1608;
	text = "Settings"; 
	onButtonClick = "closeDialog 77007;openPP = 8;null = [_this] execvm 'scripts\other\GFPPE\GFPPE.sqf'";
	x = 2 * GUI_GRID_W + GUI_GRID_X;
...
{
	text = "Defaults"; 
	tooltip = "Set Color Inversion parameters to default values.";
